...
function draw_line_charts() {
  for(var i = 0; i < line_charts.length; i++){
    ...
    // Eje de abcisas y de ordenadas
    ctx.beginPath();
    ctx.moveTo(LineChart.PADDING_LEFT, LineChart.PADDING_TOP);
    ctx.lineTo(LineChart.PADDING_LEFT, Chart.HEIGHT - LineChart.PADDING_BOTTOM);
    ctx.lineTo(line_chart.getWidth() - LineChart.PADDING_RIGHT, Chart.HEIGHT - LineChart.PADDING_BOTTOM);
    ctx.stroke();
    ...
    for(var j = 0; j < line_chart.getNumberOfVerticalLines(); j++){
      ...
      ctx.beginPath();
      ctx.moveTo(LineChart.PADDING_LEFT - LineChart.VERTICAL_LINES_WIDTH,
      ...
      ctx.lineTo(LineChart.PADDING_LEFT, 
        LineChart.PADDING_TOP + ((Chart.HEIGHT - LineChart.PADDING_TOP - LineChart.PADDING_BOTTOM)/(line_chart.getNumberOfVerticalLines()-1))*j);
      ...
      ctx.fillText(Math.ceil(number_tag).toString(), LineChart.LETTERS_MARGIN_LEFT, 
    ...
    ctx.beginPath();
    ctx.moveTo(LineChart.PADDING_LEFT + LineChart.LINES_MARGIN, 
    ...
    for(var j = 0; j < data_serie.getStructuredDataValues().length; j++){
      ...
      var value = data_serie.getStructuredDataValues()[j];
      ctx.lineTo(LineChart.PADDING_LEFT + LineChart.LINES_MARGIN + LineChart.SPACE_BETWEEN_POINTS*j, 
...
function draw_pie_charts() {
  for(var i = 0; i < pie_charts.length; i++){
    ...
    for(var j = 0; j < data_serie.getStructuredDataValues().length; j++){
      ...
      ctx.beginPath();
      ctx.moveTo(PieChart.X_CENTER + PieChart.PADDING_LEFT - PieChart.PADDING_RIGHT, PieChart.Y_CENTER + PieChart.PADDING_TOP - PieChart.PADDING_BOTTOM);
      ...
      ctx.arc(PieChart.X_CENTER + PieChart.PADDING_LEFT - PieChart.PADDING_RIGHT, 
        PieChart.Y_CENTER + PieChart.PADDING_TOP - PieChart.PADDING_BOTTOM, 
          PieChart.RADIO, lastAngle, currentAngle, false);
        
      ctx.lineTo(PieChart.X_CENTER + PieChart.PADDING_LEFT - PieChart.PADDING_RIGHT, 
        PieChart.Y_CENTER + PieChart.PADDING_TOP - PieChart.PADDING_BOTTOM);
        
      //var gradient = ctx.createRadialGradient(PieChart.X_CENTER + PieChart.PADDING_LEFT - PieChart.PADDING_RIGHT, PieChart.Y_CENTER, PieChart.SMALL_GRADIENT_RADIO, PieChart.X_CENTER, PieChart.Y_CENTER, PieChart.RADIO);
      //gradient.addColorStop(0, "white");
      //gradient.addColorStop(1, pie_chart.getSectionColor());
      
      ctx.fillStyle = pie_chart.getSectionColor();
      ctx.fill();
      ctx.stroke();
